...
import com.dh.medicamentos.dao.impl.MedicamentoDaoMariaDb;
...
public class MedicamentoServiceTest { //Estos son test de integración, no unitarios.
    ...
    private MedicamentoService medicamentoService = new MedicamentoService(new MedicamentoDaoMariaDb());
